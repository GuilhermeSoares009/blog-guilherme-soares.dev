...
window.onload = _ => {
    ...
    console.log("%cVINICIUS DIAS", 'color: #550766; font-size: 2rem; font-weight: 900; font-family: Fugaz One,Roboto,sans-serif; border-bottom: .5rem solid #f00696; border-top: .5rem solid #52c196; margin-bottom: 1.25rem; padding: .75rem;');
